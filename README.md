# Crypto_2_Polinomial_Regression
...
* Crypto_2_Polinomial_Regression is a tool, written by Grando Ruggero in Python, used for calculating the future price of a cryptocurrency pair. The tool uses the CCXT library to download the pair data from an exchange, in this case, Binance. A guide for use is available on the website https://www.megalinux.cloud. 
* Version 0.0.1
